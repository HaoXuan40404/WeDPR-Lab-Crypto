...
pub extern "system" fn Java_com_webank_wedpr_crypto_NativeInterface_secp256k1EciesEncrypt(
    ...
    let public_key = java_safe_jstring_to_bytes!(_env, result_jobject, public_key_jstring);
    let encoded_message = java_safe_jstring_to_bytes!(_env, result_jobject, message_hash_jstring);
...
pub extern "system" fn Java_com_webank_wedpr_crypto_NativeInterface_secp256k1EciesDecrypt(
    ...
    let private_key = java_safe_jstring_to_bytes!(_env, result_jobject, private_key_jstring);
    let ciphertext = java_safe_jstring_to_bytes!(_env, result_jobject, ciphertext_jstring);
...
pub extern "system" fn Java_com_webank_wedpr_crypto_NativeInterface_secp256k1GenKeyPair(
    ...
    java_safe_set_string_field!(_env, result_jobject, bytes_to_string(&pk), "publicKey");
    java_safe_set_string_field!(_env, result_jobject, bytes_to_string(&sk), "privateKey");
    result_jobject.into_inner()
}
...
pub extern "system" fn Java_com_webank_wedpr_crypto_NativeInterface_secp256k1Sign(
    ...
    let private_key = java_safe_jstring_to_bytes!(_env, result_jobject, private_key_jstring);
    let msg_hash = java_safe_jstring_to_bytes!(_env, result_jobject, msg_hash_jstring);
...
pub extern "system" fn Java_com_webank_wedpr_crypto_NativeInterface_secp256k1Verify(
    ...
    let public_key = java_safe_jstring_to_bytes!(_env, result_jobject, public_key_jstring);
    let msg_hash = java_safe_jstring_to_bytes!(_env, result_jobject, msg_hash_jstring);
    let signature = java_safe_jstring_to_bytes!(_env, result_jobject, signature_jstring);
...
pub extern "system" fn Java_com_webank_wedpr_crypto_NativeInterface_keccak256Hash(
    ...
    let encoded_message_bytes =
        java_safe_jstring_to_bytes!(_env, result_jobject, encoded_message_jstring);

    let hash = HASH.hash(&encoded_message_bytes);

    java_safe_set_string_field!(_env, result_jobject, bytes_to_string(&hash), "hash");
    result_jobject.into_inner()
}
