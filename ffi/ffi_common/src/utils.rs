...
pub fn java_new_jobject<'a>(_env: &'a JNIEnv, java_class_name: &'a str) -> JObject<'a> {
    let java_class = _env
...
pub fn java_jstring_to_bytes(_env: &JNIEnv, java_string: JString) -> Result<Vec<u8>, WedprError> {
...
pub fn java_jstring_to_string(_env: &JNIEnv, java_string: JString) -> Result<String, WedprError> {
...
pub fn java_jbytes_to_bytes(_env: &JNIEnv, java_bytes: JByteBuffer) -> Result<Vec<u8>, WedprError> {
...
pub fn c_char_pointer_to_string(param: *const c_char) -> Result<String, WedprError> {
